  ...
  <section class="gift-section q-py-xl" id="gift">
    <div class="gift-container q-mx-auto q-px-md">
      ...
      <div class="text-center q-mb-xl">
        ...
        <p class="section-subtitle text-body2">精心準備，獻給每一位生哥的粉絲</p>
      </div>
      ...
      <q-card class="gacha-block" flat>
        <q-card-section>
          <div class="gacha-header row items-center justify-center q-gutter-sm q-mb-lg">
            ...
            <tbody>
              <tr v-for="(item, idx) in gachaItems" :key="item.grade">
                <td class="text-center">
                  <span class="grade-badge" :class="{ 'special-badge': idx === 0 }">
                    {{ item.grade }}
                  </span>
                </td>
